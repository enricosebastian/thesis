...
objects = ['plastic_bottle', 'tupperware']
...
model.export(export_dir='./models/', tflite_filename='bottle-and-tupperware.tflite')


print(model.evaluate_tflite('./models/bottle-and-tupperware.tflite', val_data))
