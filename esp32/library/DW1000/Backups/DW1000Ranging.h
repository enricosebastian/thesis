...
public:
	...
	static void    startAsAnchor(char address[], const byte mode[], const byte channel, const bool randomShortAddress = false);
	static void    startAsTag(char address[], const byte mode[],const byte channel, const bool randomShortAddress = false);
